...
TFile *_file3 = TFile::Open("hists_Ta09.root");
TH2I *h2;
...
_file3->cd("Clover"); h2 = (TH2I*) gDirectory->Get("h2_Time_Energy_fv_hemi"); TH1D *h1_ta = h2->ProjectionY("E_ta",1,60);
...
hs->Add(h1_bg); h1_bg->SetLineColor(2);
hs->Add(h1_bl); h1_bl->SetLineColor(3);
hs->Add(h1_st); h1_st->SetLineColor(4);
hs->Add(h1_ta); h1_ta->SetLineColor(5);
hs->Draw("nostack hist");

TLegend *lgd = new TLegend(0.8,0.6,1,1);
lgd->AddEntry(h1_bg,"BG 0");
lgd->AddEntry(h1_bl,"Blank 2");
lgd->AddEntry(h1_st,"Stopper 14");
lgd->AddEntry(h1_ta,"Ta 9");
