...
///////////// User Area top /////////////////
	private:
		...
		TH1 *h1_Clover_Energy_allfv_forward_proton;
		TH1 *h1_Clover_dcEnergy_allfv_forward_proton;
		TH1 *h1_Clover_Energy_allfv_backward;
		TH1 *h1_Clover_dcEnergy_allfv_backward;
